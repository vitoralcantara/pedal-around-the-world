...
class CarteiraGratuidadePDF(Report):
    ...
    class band_detail(ReportBand):
        ...
        elements=(
                ...
                ObjectValue(attribute_name='data_nascimento', left=19.5*cm, top=2.6*cm,
...
#         cur_dir += '/img/'
#         elements = (
#             Image(left=1.75 * cm, top=0.5 * cm, filename=os.path.join(cur_dir, 'carteira1.jpg')),
#
#             ##############
#             ## CARTEIRA ##
#             ##############
#             ObjectValue(attribute_name='_tipo_pessoa', left=5 * cm, top=2.45 * cm,
#                         style={'fontSize': 15, 'alignment': TA_CENTER}),
#             ObjectValue(attribute_name='numero_carteira', left=4.75 * cm, top=3.75 * cm, ),
#             ObjectValue(attribute_name='nome', width=8.5 * cm, left=4.75 * cm, top=4.8 * cm, ),
#             ObjectValue(attribute_name='nome_pai', width=8.5 * cm, left=14 * cm, top=1.1 * cm, ),
#             ObjectValue(attribute_name='nome_mae', width=8.5 * cm, left=14 * cm, top=1.5 * cm, ),
#             ObjectValue(attribute_name='naturalidade', left=14 * cm, top=2.55 * cm,
#                         get_value=lambda instance: instance.naturalidade.upper()),
#             ObjectValue(attribute_name='data_nascimento', left=19.5 * cm, top=2.55 * cm,
#                         get_value=lambda instance: instance.data_nascimento.strftime('%d/%m/%Y')),
#             ObjectValue(attribute_name='nacionalidade', left=14 * cm, top=3.55 * cm,
#                         get_value=lambda instance: instance.nacionalidade.upper()),
#             ObjectValue(attribute_name='estado_civil', left=18.2 * cm, top=3.55 * cm,
#                         get_value=lambda instance: instance.estado_civil.upper()),
#             ObjectValue(attribute_name='via_carteira', left=21.45 * cm, top=3.55 * cm, ),
#             ObjectValue(attribute_name='cpf', left=14 * cm, top=4.45 * cm, ),
#             ObjectValue(attribute_name='rg', left=18.2 * cm, top=4.45 * cm, ),
#             ObjectValue(attribute_name='via_documento', left=21.45 * cm, top=4.45 * cm, ),
#             SystemField(expression='%(now:%d/%m/%Y)s', left=20.1 * cm, top=5.45 * cm, ),
#
#             #######################
#             ## FICHA DE CADASTRO ##
#             #######################
