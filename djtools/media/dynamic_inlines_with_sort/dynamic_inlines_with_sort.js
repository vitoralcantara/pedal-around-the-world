...
add_link_html = '<img src="/admin-media/img/admin/icon_addlink.gif" ' +
    'width="10" height="10" alt="Adicionar nova linha" title="Adicionar nova linha" style="margin:0.5em 1em;" />';
// "Delete"-link html code. Defaults to Django's "x" image icon, but could use text instead.
delete_link_html = '<img src="/admin-media/img/admin/icon_deletelink.gif" ' +
    'width="10" height="10" alt="Remover linha" title="Remover linha" style="margin-top:0.5em" />';
